  ...
  getJobData = async () => {
    ...
    if (responseJobData.ok) {
      ...
      const updatedJobDetailsData = {
        ...
        lifeAtCompany: {
          description: fetchedJobData.job_details.life_at_company.description,
          imageUrl: fetchedJobData.job_details.life_at_company.image_url,
        },
        ...
        skills: fetchedJobData.job_details.skills.map(eachSkill => ({
